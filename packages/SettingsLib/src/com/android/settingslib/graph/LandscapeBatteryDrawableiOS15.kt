...
open class LandscapeBatteryDrawableiOS15(private val context: Context, frameColor: Int) : Drawable(), BatteryDrawable {
    ...
    private fun loadPaths() {
        val pathString = context.resources.getString(
                R.string.LandPerimeterPathiOS15)
