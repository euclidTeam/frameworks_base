 ...
 */
open class RLandscapeBatteryDrawable(private val context: Context, frameColor: Int) : Drawable(), BatteryDrawable {
    ...
    override fun setBatteryLevel(level: Int) {
        invertFillIcon = if (level >= 67) true else if (level <= 33) false else invertFillIcon
        batteryLevel = level
